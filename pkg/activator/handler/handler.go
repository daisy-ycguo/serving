...
func (a *ActivationHandler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	if config.Tracing.DoKubeResourceTracing() && (sampled == nil || *sampled) {
		...
		if err != nil {
			...
			defer watch.Stop()
			go tracing.TracePodStartup(activeCtx, stopCh, watch.ResultChan(), tracer)
		}
	}
